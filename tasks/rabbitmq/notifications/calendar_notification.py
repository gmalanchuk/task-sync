...
def calendar_notification(obj_id: int, owner_username: str, email: str, model_name: str) -> None:
    ...
    producer_calendar_notification(
        title=obj_model.title, owner_username=owner_username, email=email, deadline=deadline, model_name=model_name
    )
